  ...
  <#elseif section="form">
    ...
    <div id="vue-app">
      <form ref="form" @submit.prevent="[onConfirmCode, onSubmit]" id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post" @submit="onSubmit">
        ...
        <input type="hidden" id="username" name="username" v-model="username">
        ...
        methods: {
          ...
          setFormFields(){
            ...
            if (this.phoneNumberAsUsername) {
              ...
              this.username = fullPhoneNumber;
              inputUsername.value = fullPhoneNumber;
              ...
              inputUsername.value = this.email;
            }
