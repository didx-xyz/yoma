<#macro userProfileFormFields>
    ...
    <!-- Skip rendering the username field if the condition is true -->
    <#if attribute.name == "username" && (realm.registrationEmailAsUsername || registrationPhoneNumberAsUsername??)>
      <!-- Skip rendering the email field if hideEmail is true -->
      <#elseif attribute.name == "email" && hideEmail??> <!-- Do nothing; email field is hidden -->
       <!-- Skip rendering the phone field -->
      <#elseif attribute.name == "phoneNumber">
      <!-- Skip rendering the terms_and_conditions field -->
      <#elseif attribute.name == "terms_and_conditions">
      <!-- Do nothing; username field is hidden -->
      <#else>
        <!-- Render all other fields and username if the condition is false -->
