-- This script is designed to be applied to an empty database to set up the database schema and populate it with test data.
DO $$
DECLARE
...
BEGIN
    ...
    -- If the script has been run, exit
    ...
    -- Set the flag indicating the script has been run
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Script did not execute succesfully. Exiting.';
    RAISE;
END $$;
