...
INSERT INTO [entity].[Organization]([Id],[Name],[WebsiteURL],[PrimaryContactName],[PrimaryContactEmail],[PrimaryContactPhone],[VATIN],[TaxNumber]
           ,[RegistrationNumber],[City],[CountryId],[StreetAddress],[Province],[PostalCode],[Tagline],[Biography],[UserId],[Approved],[DateApproved]
           ,[Active],[DateDeactivated],[LogoId],[CompanyRegistrationDocumentId],[DateCreated],[DateModified])
...
NULL, NULL, '0EFB07E6-6634-46DE-A98D-A85BF331C20E', NULL, NULL, NULL, NULL, NULL, 'F3265285-8819-4161-9D8F-22B41567D3A0',1, GETDATE(), 1, NULL, NULL,NULL,GETDATE(), GETDATE())
GO
