namespace Yoma.Core.Domain.Referral
{
  ...
  public enum ReferralLinkStatus //suffixed to avoid swagger conflicts with ActionLink domain
  {
    ...
    Cancelled,     // Cancelled by the referrer or super-admin, implicitly when a super admin when blocking a referrer, or automatically due to program inactivation or deletion; cannot be reactivated
