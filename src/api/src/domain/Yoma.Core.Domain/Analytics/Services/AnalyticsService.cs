...
namespace Yoma.Core.Domain.Analytics.Services
{
  public class AnalyticsService : IAnalyticsService
  {
    ...
    private OrganizationSearchResultsEngagement SearchOrganizationEngagementInternal(OrganizationSearchFilterEngagement filter)
    {
      ...
      {
        TopCompleted = new OpportunitySkillTopCompleted { Legend = "Most completed skills", TopCompleted = [.. flattenedSkills.Take(Skill_Count).Select(g => new OpportunitySkillCompleted
        {
          Id = g.Skill.Id,
          Name = g.Skill.Name,
