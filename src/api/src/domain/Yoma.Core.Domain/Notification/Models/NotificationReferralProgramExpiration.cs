...
{
  public sealed class NotificationReferralProgramExpiration : NotificationBase
  {
    ...
    public override List<NotificationBase> FlattenItems()
    {
      ...
      return [.. Programs.Select(item => new NotificationReferralProgramExpiration
      {
  ...
  public sealed class NotificationReferralProgramExpirationItem
  {
    [JsonProperty("name")]
