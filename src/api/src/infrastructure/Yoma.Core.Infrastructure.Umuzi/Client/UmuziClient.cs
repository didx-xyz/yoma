...
namespace Yoma.Core.Infrastructure.Umuzi.Client
{
    ...
    ISyncProviderClientUserAuthentication
  {
    ...
    // Retain Umuzi's source vocabulary; resolve it to the approved Yoma taxonomy.
    private static readonly Dictionary<Guid, string[]> CategoryMappings = new()
    {
      // Agriculture, Food, Environment and Climate
      { new Guid("2ccbacf7-1ed9-4e20-bb7c-43edfdb3f950"), ["Agriculture", "Environment and Climate"] },
      // Technology, AI & Data
      { new Guid("fa564c1c-591a-4a6d-8294-20165da8866b"), ["AI Data and Analytics", "AI, Data and Analytics", "Technology and Digitization"] },
