...
{
  public sealed class UmuziClientFactory :
    ...
    ISyncProviderClientFactory<ISyncProviderClientUserAuthentication>
  {
    ...
    private readonly IOptions<UmuziOptions> _options;
    ...
    ISyncProviderClientPullVerification
      ISyncProviderClientFactory<ISyncProviderClientPullVerification>.CreateClient()
      => CreateClient();

    ISyncProviderClientUserAuthentication
      ISyncProviderClientFactory<ISyncProviderClientUserAuthentication>.CreateClient()
      => CreateClient();
    #endregion

    #region Private Members
    private UmuziClient CreateClient()
    {
      return new UmuziClient(
        _logger,
