...
{
  public class OpportunityCountryRepository : BaseRepository<Entities.OpportunityCountry>, IRepository<OpportunityCountry>
  {
    #region Constructor
    ...
    public Task Update(OpportunityCountry item)
    {
