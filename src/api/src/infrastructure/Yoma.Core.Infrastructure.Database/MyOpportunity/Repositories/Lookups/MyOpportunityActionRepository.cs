...
{
  public class MyOpportunityActionRepository : BaseRepository<Entities.Lookups.MyOpportunityAction, Guid>, IRepository<MyOpportunityAction>
  {
    #region Constructor
    ...
    public IQueryable<MyOpportunityAction> Query(LockMode lockMode)
    {
