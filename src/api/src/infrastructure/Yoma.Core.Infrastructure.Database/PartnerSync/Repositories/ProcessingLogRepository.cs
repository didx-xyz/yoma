...
namespace Yoma.Core.Infrastructure.Database.PartnerSync.Repositories
{
  public class ProcessingLogRepository : BaseRepository<Entities.ProcessingLog, Guid>, IRepositoryBatched<ProcessingLog>
  {
    ...
    {
      return _context.PartnerSyncProcessingLog.Select(entity => new ProcessingLog
      {
        Id = entity.Id,
    ...
    public async Task<ProcessingLog> Create(ProcessingLog item)
    {
      ...
      _context.PartnerSyncProcessingLog.Add(entity);
    ...
    public async Task<List<ProcessingLog>> Create(List<ProcessingLog> items)
    {
      ...
      _context.PartnerSyncProcessingLog.AddRange(entities);
      await _context.SaveChangesAsync();
    ...
    {
      var entity = _context.PartnerSyncProcessingLog.Where(o => o.Id == item.Id).SingleOrDefault()
    ...
    public async Task<List<ProcessingLog>> Update(List<ProcessingLog> items)
    {
      ...
      var entities = _context.PartnerSyncProcessingLog.Where(o => itemIds.Contains(o.Id));
      ...
      _context.PartnerSyncProcessingLog.UpdateRange(entities);
      await _context.SaveChangesAsync();
