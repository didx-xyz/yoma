...
namespace Yoma.Core.Infrastructure.Database.PartnerSync.Repositories.Lookups
{
  public class ProcessingStatusRepository : BaseRepository<Entities.Lookups.ProcessingStatus, Guid>, IRepository<ProcessingStatus>
  {
    ...
    public IQueryable<ProcessingStatus> Query(LockMode lockMode)
    {
    ...
    {
      return _context.PartnerSyncProcessingStatus.Select(entity => new ProcessingStatus
      {
        Id = entity.Id,
        Name = entity.Name
      });
