    ...
    public partial class ApplicationDb_Custom_Fields_Treasury_Payout : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Reward",
                table: "Transaction",
                columns: new[] { "UserId", "SourceEntityType", "MyOpportunityId", "ReferralLinkUsageId", "PayoutTransactionId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Opportunity",
                table: "MyOpportunity",
                columns: new[] { "VerificationStatusId", "DateStart", "DateEnd", "DateCompleted", "ZltoReward", "Recommendable", "StarRating", "DateCreated", "DateModified" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldDefinition_EntityType_EntityContext_DataType_IsR~",
                schema: "Core",
                table: "CustomFieldDefinition",
                columns: new[] { "EntityType", "EntityContext", "DataType", "IsRequired", "IsSystem" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldDefinition_EntityType_EntityContext_IsActive_Gro~",
                schema: "Core",
                table: "CustomFieldDefinition",
                columns: new[] { "EntityType", "EntityContext", "IsActive", "Group", "SubGroup", "SortOrder" });
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "CustomFieldDefinitionId", "IsActive", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldOption_CustomFieldDefinitionId_Key",
                schema: "Core",
                table: "CustomFieldOption",
                columns: new[] { "CustomFieldDefinitionId", "Key" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("Npgsql:IndexInclude", new[] { "OpportunityId", "MyOpportunityId" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldValue_Definition_ValueDateTime",
                schema: "Core",
                table: "CustomFieldValue",
                columns: new[] { "CustomFieldDefinitionId", "ValueDateTime" },
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Core",
                table: "CustomFieldValue",
                columns: new[] { "CustomFieldDefinitionId", "ValueNumeric" },
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Core",
                table: "CustomFieldValue",
                columns: new[] { "MyOpportunityId", "CustomFieldDefinitionId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Core",
                table: "CustomFieldValue",
                columns: new[] { "OpportunityId", "CustomFieldDefinitionId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Payout",
                table: "Transaction",
                columns: new[] { "UserId", "StatusId", "DateCreated", "DateModified" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Opportunity",
                table: "MyOpportunity",
                columns: new[] { "VerificationStatusId", "DateStart", "DateEnd", "DateCompleted", "ZltoReward", "YomaReward", "Recommendable", "StarRating", "DateCreated", "DateModified" });
