...
namespace Yoma.Core.Infrastructure.Database.Migrations
{
  ...
  [Migration("20260915100000_ApplicationDb_Custom_Fields_Treasury_Payout_SSI")]
  partial class ApplicationDb_Custom_Fields_Treasury_Payout_SSI
  {
    /// <inheritdoc />
...
#pragma warning disable 612, 618
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.ActionLink.Entities.Link", b =>
          {
            ...
            b.Property<bool?>("LockToDistributionList")
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.ActionLink.Entities.LinkUsageLog", b =>
          {
            ...
            b.Property<string>("UsernameClaimed")
            ...
            b.HasIndex("UsernameClaimed", "DateCreated");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldDefinition", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.Property<string>("EntityContext")
            ...
            b.ToTable("CustomFieldDefinition", "Core");
          });

      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldOption", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.HasIndex("CustomFieldDefinitionId", "Key")
                      .IsUnique();

            b.HasIndex("CustomFieldDefinitionId", "IsActive", "SortOrder");

            b.ToTable("CustomFieldOption", "Core");
          });

      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldValue", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.HasIndex("MyOpportunityId", "CustomFieldDefinitionId")
                      .IsUnique()
                      .HasFilter("\"MyOpportunityId\" IS NOT NULL");

            b.HasIndex("OpportunityId", "CustomFieldDefinitionId")
                      .IsUnique()
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Core.Entities.DownloadSchedule", b =>
          {
            ...
            b.HasIndex("UserId", "Type", "FilterHash", "StatusId", "FileId", "DateCreated", "DateModified");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Entity.Entities.Lookups.SettingsDefinition", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.ToTable("SettingsDefinition", "Entity");
          });
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Entity.Entities.Organization", b =>
          {
            ...
            b.Property<string>("SSOClientIdInbound")
                      .HasColumnType("varchar(255)");

            b.Property<string>("SSOClientIdOutbound")
                      .HasColumnType("varchar(255)");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Lookups.Entities.EngagementType", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.ToTable("EngagementType", "Lookup");
          });
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.MyOpportunity.Entities.MyOpportunity", b =>
          {
            ...
            b.HasIndex("VerificationStatusId", "DateStart", "DateEnd", "DateCompleted", "ZltoReward", "Recommendable", "StarRating", "DateCreated", "DateModified");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Opportunity.Entities.Opportunity", b =>
          {
            ...
            b.Property<bool?>("ShareWithPartners")
                      .HasColumnType("boolean");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.PartnerSync.Entities.Lookups.Partner", b =>
          {
            ...
            b.Property<string>("ActionsEnabled")
                      .HasColumnType("text");
            ...
            b.Property<string>("SyncCapabilities")
                      .IsRequired()
                      .ValueGeneratedOnAdd()
                      .HasColumnType("text")
                      .HasDefaultValue("{\"Push\":{\"Opportunity\":[\"Entity\"]}}");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.PartnerSync.Entities.PartnerSyncTracking", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.HasIndex("PartnerId", "DateStamp");

            b.HasIndex("SyncType", "EntityType", "SyncScope", "PartnerId", "DateStamp");

            b.HasIndex("SyncType", "EntityType", "SyncScope", "PartnerId", "Status", "DateStamp");

            b.ToTable("Tracking", "PartnerSync");
          });

      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.PartnerSync.Entities.PartnerSyncUser", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
            ...
            b.Property<DateTimeOffset?>("DateLastRedirect")
                      .HasColumnType("timestamp with time zone");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.PartnerSync.Entities.ProcessingLog", b =>
          {
            ...
            b.HasIndex("SyncType", "EntityType", "MyOpportunityId", "StatusId", "DateModified");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Referral.Entities.Lookups.ProgramStatus", b =>
          {
            ...
            b.ToTable("ProgramStatus", "Referral");
          });
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Referral.Entities.Program", b =>
          {
            ...
            b.Property<int?>("CompletionLimit")
                      .HasColumnType("integer");

            b.Property<int?>("CompletionLimitReferee")
                      .HasColumnType("integer");

            b.Property<int?>("CompletionTotal")
                      .HasColumnType("integer");

            b.Property<int?>("CompletionWindowInDays")
                      .HasColumnType("integer");
            ...
            b.Property<bool>("MultipleLinksAllowed")
                      .HasColumnType("boolean");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Referral.Entities.ProgramPathwayStep", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Referral.Entities.ProgramPathwayTask", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uuid");
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.SSI.Entities.SSICredentialIssuance", b =>
          {
            ...
            b.HasIndex("SchemaTypeId", "UserId", "OrganizationId", "MyOpportunityId")
                      .IsUnique();

            NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("SchemaTypeId", "UserId", "OrganizationId", "MyOpportunityId"), false);
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldOption", b =>
          {
            b.HasOne("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldDefinition", null)
                      .WithMany("Options")
      ...
      modelBuilder.Entity("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldValue", b =>
          {
            b.HasOne("Yoma.Core.Infrastructure.Database.Core.Entities.CustomFieldDefinition", "CustomFieldDefinition")
                      .WithMany()
                      .HasForeignKey("CustomFieldDefinitionId")
                      .OnDelete(DeleteBehavior.NoAction)
                      .IsRequired();

            b.HasOne("Yoma.Core.Infrastructure.Database.MyOpportunity.Entities.MyOpportunity", null)
                      .WithMany("CustomFieldValues")
                      .HasForeignKey("MyOpportunityId")
                      .OnDelete(DeleteBehavior.NoAction);

            b.HasOne("Yoma.Core.Infrastructure.Database.Opportunity.Entities.Opportunity", null)
                      .WithMany("CustomFieldValues")
                      .HasForeignKey("OpportunityId")
                      .OnDelete(DeleteBehavior.NoAction);
