...
namespace Yoma.Core.Infrastructure.Zlto.Models
{
  ...
  {
    [JsonProperty("data")]
    public List<StoreInfo> Items { get; set; } = null!;
  }
  ...
  public class StoreInfo
  {
    ...
    public StoreCountry Country { get; set; } = null!;
  ...
  {
    [JsonProperty("data")]
    public List<StoreItemCategory> Items { get; set; } = null!;
  }
  ...
  public class StoreItemCategory
  {
    ...
    public string ItemCatImage { get; set; } = null!;

    [JsonProperty("item_cat_name"), Required]
    public string ItemCatName { get; set; } = null!;

    [JsonProperty("item_cat_description"), Required]
    public string ItemCatDescription { get; set; } = null!;

    [JsonProperty("item_cat_details"), Required]
    public string ItemCatDetails { get; set; } = null!;
  ...
  {
    [JsonProperty("data")]
    public List<StoreItem> Items { get; set; } = null!;
  }
  ...
  public class StoreItem
  {
    ...
    public string StoreCatId { get; set; } = null!;

    [JsonProperty("store_info_si")]
    public StoreInfo StoreInfoSi { get; set; } = null!;

    [JsonProperty("item_cat_id")]
    public string ItemCatId { get; set; } = null!;

    [JsonProperty("item_category_ic")]
    public StoreItemCategory ItemCategoryIc { get; set; } = null!;
    ...
    public string ReservedUserId { get; set; } = null!;

    [JsonProperty("item_logo")]
    public string ItemLogo { get; set; } = null!;
  ...
  public class ItemActionRequest
  {
    ...
    [JsonProperty("reserved_user_id")]
    public string WalletOwnerId { get; set; } = null!;
