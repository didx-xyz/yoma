...
interface RefereeNextActionProps {
  usage: ReferralLinkUsageInfo;
  program: ProgramInfo;
}

export const RefereeNextAction: React.FC<RefereeNextActionProps> = ({
  usage,
  program,
}) => {
        ...
        >
          ...
          <div className="mt-3 space-y-3">
            ...
            <FormMessage messageType={FormMessageType.Info}>
              Click a task above → <strong>Go to Opportunity</strong> → complete
              it. Then upload proof via{" "}
          ...
          {serverError || usageError || programError || !usage || !program ? (
            ...
            <>
              ...
              {usage.status === "Pending" && (
                <RefereeNextAction usage={usage} program={program} />
              )}
