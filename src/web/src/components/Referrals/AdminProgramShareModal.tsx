...
import { ProgramReferrerLinkDetails } from "./ProgramReferrerLinkDetails";
import { ShareButtons } from "./ShareButtons";

interface AdminProgramShareModalProps {
  isOpen: boolean;
  onClose: () => void;
  programId: string;
  programName: string;
  link: ProgramLinkReferrer | null;
  rewardAmount?: number | null;
}

export const AdminProgramShareModal: React.FC<AdminProgramShareModalProps> = ({
  isOpen,
  onClose,
  programId,
  programName,
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="px-6 text-center">
              ...
              <div className="text-gray-dark mt-2 text-sm">
                Share this program with ambassadors on your preferred platform.
              </div>
            </div>
          </div>
            ...
            <div className="border-base-300 bg-base-100 flex flex-col gap-4 overflow-visible rounded-lg border p-4">
              ...
              <div className="flex w-full min-w-0 flex-col md:flex-1 md:basis-1/2">
                ...
                <div className="text-base-content/60 mb-4 text-sm">
                  Share your program referrer link on your preferred platform
                </div>
                <ShareButtons
