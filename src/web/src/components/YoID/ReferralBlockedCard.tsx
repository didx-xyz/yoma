...
export const ReferralBlockedCard: React.FC<ReferralBlockedCardProps> = ({
  ...
  return (
    <div className="flex h-full flex-col gap-3 rounded-lg bg-white p-4 text-xs text-black md:text-sm">
      <div className="flex items-start gap-2">
        <IoWarning className="text-error mt-0.5 h-5 w-5 flex-shrink-0" />
        <div className="flex-1">
          <p className="text-error font-semibold">Referral Access Suspended</p>
      ...
      <div className="border-gray-light mt-2 border-t pt-3">
        <Link
          className="notranslate text-green hover:text-green-dark flex w-full items-center justify-between text-xs font-semibold underline"
