...
const OrganisationOpportunities: NextPageWithLayout<{
  id: string;
  user: User;
}> = ({ id }) => {
...
OrganisationOpportunities.getLayout = function getLayout(page: ReactElement) {
  return (
    <MainLayout>
...
export default withAuth(OrganisationOpportunities);
