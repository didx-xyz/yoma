...
const OrganisationCredentials: NextPageWithLayout<{
  id: string;
  user: User;
}> = ({ id }) => {
...
OrganisationCredentials.getLayout = function getLayout(page: ReactElement) {
  return (
    <MainLayout>
...
export default withAuth(OrganisationCredentials);
