...
const OrganisationTransactions: NextPageWithLayout<{
  id: string;
  user: User;
}> = ({ id }) => {
...
OrganisationTransactions.getLayout = function getLayout(page: ReactElement) {
  return (
    <MainLayout>
...
export default withAuth(OrganisationTransactions);
